...
import {HighlightableRichText} from '#/components/HighlightableRichText'
      ...
      <Prompt.Outer control={control}>
        <Prompt.Content>
          ...
          <Text
            ...
            <Trans>
              PARA cannot confirm the authenticity of the claimed date.
            </Trans>
          </Text>
          <Prompt.Actions>
