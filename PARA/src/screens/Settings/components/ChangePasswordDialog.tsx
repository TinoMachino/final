...
function Inner() {
  ...
  const uiStrings = {
    ...
    Done: {
      ...
      message: _(
        msg`Your password has been changed successfully! Please use your new password when you sign in to PARA from now on.`,
      ),
    },
  }
  ...
  const onRequestCode = async () => {
    ...
    try {
      ...
      if (isNetworkError(e)) {
        ...
        logger.error('Failed to request password reset', {safeMessage: String(e)})
