...
import {CircleInfo_Stroke2_Corner0_Rounded as CircleInfo,CircleInfo_Stroke2_Corner0_Rounded as ErrorIcon} from '#/components/icons/CircleInfo'
...
function useToastFontScaleCompensation() {
  ...
  const fontScaleCompensation = useMemo(
    () => parseInt(fonts.scale, 10) * -1 * 0.65,
    [fonts.scale],
  )
  return useMemo(
    () => ({
