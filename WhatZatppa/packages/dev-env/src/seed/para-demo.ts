...
export default async (sc: SeedClient) => {
  ...
  const castVote = async (agent: any, did: string, cabUri: string, optionIndex: number) => {
    try {
  ...
  const voterTurnout = [0.6, 0.5, 0.7, 0.8, 0.6, 0.9, 0.8, 0.7, 0.5, 0.6, 0.5, 0.9, 0.8, 0.7, 0.6, 0.5, 0.8, 0.7, 0.6, 0.5]
  ...
  const delegationDefs = [
    {from: 'dan', to: 'alice', cabIdx: null, scope: ['||#PresupuestoParticipativo', '||#MedioAmbiente'], reason: 'Confío en el criterio de Alice respecto a infraestructura verde y espacios públicos.'},
    {from: 'eva', to: 'carla', cabIdx: null, scope: ['||#EducacionLaica', '||#DerechosLaborales'], reason: 'Carla tiene amplia experiencia en políticas educativas y laborales. Le delego mi voz en estos temas.'},
    {from: 'rodrigo', to: 'eva', cabIdx: null, scope: ['||#DerechosLaborales', '||#TransportePublico'], reason: 'Eva ha defendido a transportistas por décadas. Mi voto en temas laborales va con ella.'},
    {from: 'karla', to: 'eva', cabIdx: null, scope: ['||#EducacionLaica', '||#EducacionIndigena'], reason: 'Eva entiende la educación rural. Delego para que mi voz cuente donde yo no puedo estar.'},
    {from: 'luis', to: 'alice', cabIdx: null, scope: ['||#SaludPublica', '||#PresupuestoParticipativo'], reason: 'Alice ha impulsado clínicas móviles. En salud comunitaria, confío en su juicio.'},
    {from: 'tomas', to: 'alice', cabIdx: null, scope: ['||#SaludPublica', '||#DerechosHumanos'], reason: 'Como jubilado, necesito representación que entienda pensiones y salud. Alice ha demostrado sensibilidad.'},
    {from: 'pablo', to: 'bob', cabIdx: null, scope: ['||#TransportePublico', '||#Innovacion'], reason: 'Bob entiende de infraestructura. En movilidad y tecnología, prefiero delegar a quien sabe.'},
    {from: 'isabel', to: 'mariana', cabIdx: null, scope: ['||#DerechosHumanos', '||#Seguridad'], reason: 'Mariana litiga casos de violencia de género. En temas de justicia, su criterio es invaluable.'},
    {from: 'olivia', to: 'isabel', cabIdx: null, scope: ['||#DerechosHumanos', '||#Cultura'], reason: 'Isabel une arte y activismo. En temas culturales con perspectiva feminista, delego en ella.'},
    {from: 'nicolas', to: 'bob', cabIdx: null, scope: ['||#TransportePublico', '||#MovilidadSostenible'], reason: 'Bob y yo compartimos visión de movilidad inteligente. Delego para fortalecer nuestro bloque.'},
    {from: 'jorge', to: 'fernando', cabIdx: null, scope: ['||#Innovacion', '||#Transparencia'], reason: 'Fernando entiende tecnología y gobernanza. En innovación cívica, su voz es la más informada.'},
    {from: 'fernando', to: 'mariana', cabIdx: null, scope: ['||#Transparencia', '||#Anticorrupcion'], reason: 'Mariana ha destapado casos que yo no podría. En anticorrupción, delego sin dudar.'},
    {from: 'gabriela', to: 'mariana', cabIdx: null, scope: ['||#Seguridad', '||#Transparencia'], reason: 'Como periodista, necesito delegar en alguien con rigor legal. Mariana es esa persona.'},
    {from: 'hector', to: 'gabriela', cabIdx: null, scope: ['||#Economia', '||#Innovacion'], reason: 'Gaby aplica evidencia empírica a sus análisis. En políticas basadas en datos, delego en ella.'},
    {from: 'sofia', to: 'quetzali', cabIdx: null, scope: ['||#SoberaniaAlimentaria', '||#EconomiaLocal'], reason: 'Quetzali conoce la cadena alimentaria desde la sierra. En soberanía alimentaria, es mi referente.'},
    {from: 'dan', to: 'fernando', cabIdx: 1, scope: ['||#Economia'], reason: 'En este cabildeo específico sobre impuesto al carbono, prefiero la visión económica de Fernando.'},
    {from: 'eva', to: 'rodrigo', cabIdx: 6, scope: ['||#DerechosLaborales'], reason: 'Rodrigo es quien más sabe de condiciones laborales reales. En este cabildeo de salario, delego en él.'},
    {from: 'bob', to: 'nicolas', cabIdx: 14, scope: ['||#TransportePublico'], reason: 'Nico es el ingeniero. En el tren eléctrico, su voto técnico pesa más que el mío político.'},
    {from: 'carla', to: 'karla', cabIdx: 10, scope: ['||#EducacionIndigena'], reason: 'Karla vive la educación intercultural. En este cabildeo específico, su experiencia es insustituible.'},
    {from: 'alice', to: 'olivia', cabIdx: 15, scope: ['||#Cultura'], reason: 'Olivia es la artista. En el cabildeo de murales, delego mi voto en quien entiende el impacto cultural.'},
    {from: 'mariana', to: 'fernando', cabIdx: 7, scope: ['||#Transparencia'], reason: 'Fernando diseñó sistemas de contratos abiertos. En este cabildeo, su expertise es clave.'},
    {from: 'pablo', to: 'karla', cabIdx: 16, scope: ['||#Educacion'], reason: 'Karla entiende la barrera del transporte escolar. Como estudiante, delego en quien conoce la problemática.'},
    {from: 'tomas', to: 'luis', cabIdx: 12, scope: ['||#SaludPublica'], reason: 'Luis es médico comunitario. En salud preventiva, su voto es el más informado.'},
    {from: 'jorge', to: 'hector', cabIdx: 9, scope: ['||#Innovacion'], reason: 'Hector analiza políticas tecnológicas con rigor académico. En identidad digital, prefiero su criterio.'},
  ]
  ...
  const seededPosts = [
    ...
    {agent: 'alice', party: 'Morena', title: 'Reforma energética: soberanía y precios justos', text: 'La reforma energética debe garantizar precios justos de electricidad a todas las familias. La soberanía energética es prioridad nacional — no podemos depender de importaciones cuando tenemos recursos propios.', postType: 'policy', bskyTags: ['policy', 'energia', 'reforma'], paraFlairs: ['||#Policy', '||#EmpresaPublicaDeAgua']},
    {agent: 'alice', party: 'Morena', title: 'Movilidad sostenible: plan de acción', text: 'Ampliación de ciclovías y transporte eléctrico en zonas urbanas prioritarias. La contaminación no espera y nuestras ciudades necesitan respirar.', postType: 'policy', bskyTags: ['policy', 'movilidad', 'sustentabilidad'], paraFlairs: ['||#Policy', '||#TransportePublico']},
    {agent: 'alice', party: 'Morena', title: 'Hoy votamos la ampliación de techos verdes', text: 'Tras 6 meses de implementación piloto, redujimos temperatura interior en 4°C promedio. Ahora vamos por 15 edificios públicos más. La evidencia nos respalda.', postType: 'matter', bskyTags: ['matter', 'ambiente', 'arquitectura'], paraFlairs: ['||#TechosVerdes', '|#RespetoAmbiental']},

    // Eva (PT — Líder sindical)
    {agent: 'eva', party: 'PT', title: '¿Salario mínimo a $12,000?', text: '¿Apoyas incrementar el salario mínimo a $12,000 mensuales con prestaciones completas? Tu opinión construye la agenda legislativa de quienes trabajamos 48 horas semanales.', postType: 'raq', bskyTags: ['raq', 'salario', 'trabajo'], paraFlairs: ['|#!RAQ']},
    {agent: 'eva', party: 'PT', title: '1° de mayo: lo logrado y lo que falta', text: 'Celebramos la jornada laboral de 40 horas aprobada. Pero seguimos luchando por salarios dignos, prestaciones reales y seguridad social universal. No bajamos la guardia.', postType: 'matter', bskyTags: ['matter', 'trabajo', '1demayo'], paraFlairs: ['||#DerechosLaborales', '|#Matter']},
    {agent: 'eva', party: 'PT', title: '¿Qué política social debería ser prioridad nacional?', text: 'Vivienda, salud, educación o alimentación. ¿Cuál es tu prioridad? Quiero escuchar a quienes viven estas realidades todos los días.', postType: 'open_question', bskyTags: ['open_question', 'social', 'prioridad'], paraFlairs: ['|#?OpenQuestion']},

    // Karla (Morena — Maestra rural)
    {agent: 'karla', party: 'Morena', title: 'Mi experiencia votando en cabildeo por primera vez', text: 'Como maestra rural, esta es mi primera experiencia en cabildeo digital. Estoy aprendiendo que la política no es solo votar cada 3 años, es participar todos los días desde donde estamos.', postType: 'matter', bskyTags: ['matter', 'juventud', 'democracia'], paraFlairs: ['|#Matter', '||#EducacionLaica']},

    // Pablo (Morena — Estudiante)
    {agent: 'pablo', party: 'Morena', title: 'Mi primera votación informada', text: '19 años y descubriendo que mi voto en un cabildeo puede decidir si hay transporte gratuito para estudiantes. Eso es poder real, no abstracto.', postType: 'matter', bskyTags: ['matter', 'juventud', 'democracia'], paraFlairs: ['|#Matter', '||#EducacionLaica']},

    // Rodrigo (PT — Taxista)
    {agent: 'rodrigo', party: 'PT', title: 'Tarifa diferenciada: una victoria para quienes movemos la ciudad', text: 'Ganamos. La tarifa diferenciada para transportistas organizados es justicia. Ahora toca cuidar que la implementación llegue a todos, no solo a los de siempre.', postType: 'matter', bskyTags: ['matter', 'taxistas', 'transporte'], paraFlairs: ['||#TransportePublico', '|#Matter']},
    {agent: 'rodrigo', party: 'PT', title: 'Semáforo en verde / taxista: nah', text: 'Semáforo en verde. Colega: "Déjame revisar si viene el camión" *se queda quieto* Yo en el asiento trasero: 🙃🚕', postType: 'meme', bskyTags: ['meme', 'taxista', 'cdmx', 'humor'], paraFlairs: ['#MEME']},

    // Tomas (Morena — Jubilado IMSS)
    {agent: 'tomas', party: 'Morena', title: 'Pensiones dignas: una deuda pendiente', text: '40 años de servicio al IMSS y mi pensión no alcanza para medicamentos. No pedimos limosna, exigimos lo que contribuimos toda la vida con nuestro trabajo.', postType: 'open_question', bskyTags: ['open_question', 'pensiones', 'adultosmayores'], paraFlairs: ['|#?OpenQuestion']},

    // Bob (PAN — Senador)
    {agent: 'bob', party: 'PAN', title: 'Iniciativa anticorrupción: fortalecimiento institucional', text: 'Presenté iniciativa de fortalecimiento institucional anticorrupción con fiscalía autónoma, rendición de cuentas y protección a denunciantes. La corrupción mata y debemos combatirla sin tregua.', postType: 'policy', bskyTags: ['policy', 'anticorrupcion', 'instituciones'], paraFlairs: ['||#Policy', '||#LimiteDeMandatos']},
    {agent: 'bob', party: 'PAN', title: 'Infraestructura hídrica para 50 comunidades rurales', text: 'Plan de inversión para garantizar abasto de agua en comunidades rurales del centro del país. El agua es derecho, no privilegio.', postType: 'matter', bskyTags: ['matter', 'agua', 'infraestructura'], paraFlairs: ['|#Matter']},
    {agent: 'bob', party: 'PAN', title: '¿Tu prioridad para el siguiente período legislativo?', text: 'Seguridad, economía, salud o educación. ¿Cuál es tu prioridad? Vota y construyamos juntos la agenda que el país necesita.', postType: 'open_question', bskyTags: ['open_question', 'prioridades', 'legislativo'], paraFlairs: ['|#?OpenQuestion']},

    // Nicolas (PAN — Ingeniero civil)
    {agent: 'nicolas', party: 'PAN', title: 'Tren eléctrico: ingeniería para el futuro', text: 'Respaldo el tren eléctrico con datos duros: reduce emisiones 40%, conecta la ciudad en 32 minutos y genera 12,000 empleos directos. La infraestructura debe ser sostenible.', postType: 'policy', bskyTags: ['policy', 'tren', 'infraestructura'], paraFlairs: ['||#Policy', '||#TransportePublico']},
    {agent: 'nicolas', party: 'PAN', title: 'Blindaje electoral con software auditoriable', text: 'Iniciativa para blindar elecciones de interferencia externa con auditoría de software y observación internacional. La democracia se defiende con tecnología, no solo con buenas intenciones.', postType: 'policy', bskyTags: ['policy', 'elecciones', 'democracia'], paraFlairs: ['||#Policy']},

    // Carla (PRI — Regidora)
    {agent: 'carla', party: 'PRI', title: 'Modernización energética con inversión mixta', text: 'Impulso la modernización del sector energético con inversión privada participativa y transición sustentable. El reto es hacerlo sin dejar atrás a las comunidades petroleras.', postType: 'policy', bskyTags: ['policy', 'energia', 'modernizacion'], paraFlairs: ['||#Policy', '||#FondoDeAdaptacionAlCambioClimatico']},
    {agent: 'carla', party: 'PRI', title: 'Becas de excelencia: aclaración importante', text: 'El requisito de promedio mínimo es 8.5, no 9.0 como circuló en redes. La convocatoria cierra el 30 de noviembre. No dejen pasar la oportunidad por desinformación.', postType: 'raq', bskyTags: ['raq', 'educacion', 'becas'], paraFlairs: ['||#EscuelasPublicas', '|#!RAQ']},
    {agent: 'carla', party: 'PRI', title: 'Tarifas de transporte: consulta pública abierta', text: 'La Secretaría de Movilidad abre consulta sobre ajuste tarifario. ¿Consideras que el incremento del 8% es justificado por la inflación? Quiero saber qué piensan quienes usan el transporte diario.', postType: 'open_question', bskyTags: ['open_question', 'transporte', 'tarifas'], paraFlairs: ['||#TransportePublico', '|#?OpenQuestion']},

    // Dan (PVEM — Activista ambiental)
    {agent: 'dan', party: 'PVEM', title: 'Ley integral de cambio climático', text: 'Metas claras de reducción de emisiones para 2030 y fondo de adaptación ecológica. Sin ley, sin compromiso; sin compromiso, sin futuro.', postType: 'policy', bskyTags: ['policy', 'clima', 'emisiones'], paraFlairs: ['||#Policy', '||#FondoDeAdaptacionAlCambioClimatico']},
    {agent: 'dan', party: 'PVEM', title: 'Corredores biológicos urbanos', text: 'Crear corredores que conecten áreas verdes y promuevan biodiversidad en zonas metropolitanas. Las ciudades también son hábitat.', postType: 'policy', bskyTags: ['policy', 'biodiversidad', 'urbanismo'], paraFlairs: ['||#Policy']},
    {agent: 'dan', party: 'PVEM', title: '¿Alianza opositora 2025?', text: '¿Estás de acuerdo con la alianza opositora para las elecciones de 2025? Tu opinión cuenta en la construcción de rumbo, no solo en las urnas.', postType: 'raq', bskyTags: ['raq', 'alianza', 'elecciones'], paraFlairs: ['|#!RAQ']},

    // Eva (PVEM — también líder sindical, cross-post)
    {agent: 'eva', party: 'PVEM', title: 'Calidad del aire en 8 ciudades: datos alarmantes', text: 'Niveles críticos de PM2.5 en 8 zonas metropolitanas. Se requieren acciones urgentes, no promesas de campaña. La salud respiratoria de millones está en juego.', postType: 'matter', bskyTags: ['matter', 'aire', 'salud'], paraFlairs: ['|#Matter', '||#ServiciosPublicosDeSalud']},
    {agent: 'eva', party: 'PVEM', title: 'Reciclaje intensivo con recompensas ciudadanas', text: 'Puntos de acopio digitales y recompensas por kilo de material reciclado. El cuidado ambiental debe ser económicamente viable para todas las familias.', postType: 'matter', bskyTags: ['matter', 'reciclaje', 'medioambiente'], paraFlairs: ['|#Matter']},

    // Luis (PT — Médico comunitario)
    {agent: 'luis', party: 'PT', title: 'Salud preventiva: derecho, no privilegio', text: 'Como médico comunitario, veo cómo la prevención salva vidas y dinero. Cada peso invertido en salud preventiva ahorra 7 en tratamiento curativo. La evidencia es clara.', postType: 'matter', bskyTags: ['matter', 'salud', 'prevencion'], paraFlairs: ['||#SaludPublica', '|#Matter']},

    // Fernando (MC — Emprendedor social)
    {agent: 'fernando', party: 'MC', title: 'Presupuesto participativo digital', text: 'Votación digital ciudadana y transparencia total en el gasto público. Cada peso, rastreable. La rendición de cuentas no puede esperar a que alguien más la exija.', postType: 'policy', bskyTags: ['policy', 'presupuesto', 'digital'], paraFlairs: ['||#Policy', '||#PresupuestoParticipativo']},
    {agent: 'fernando', party: 'MC', title: 'Transparencia fiscal en tiempo real', text: 'Seguimiento de cada peso gastado por dependencias federales. Sin excepciones, sin zonas grises. El dinero público debe ser visible por diseño.', postType: 'policy', bskyTags: ['policy', 'transparencia', 'fiscal'], paraFlairs: ['||#Policy']},
    {agent: 'fernando', party: 'MC', title: 'Responsabilidad compartida en transición energética', text: 'La transición no puede dejar atrás a las comunidades petroleras. Propongo fondo de reconversión laboral con inversión privada y pública. Justicia ambiental es justicia laboral.', postType: 'policy', bskyTags: ['policy', 'transicion', 'empleo'], paraFlairs: ['||#Policy']},
    {agent: 'fernando', party: 'MC', title: 'Reunión de coordinación: viernes 10am', text: 'Recordatorio: mañana viernes 10:00 hrs reunión de vocales en Centro Cultural Centro. Agenda: asignación de mesas de trabajo. Puntualidad, por favor.', postType: 'meta', bskyTags: ['meta', 'anuncio', 'asamblea'], paraFlairs: ['||#PresupuestoParticipativo', '#META']},

    // Jorge (MC — Empresario tech)
    {agent: 'jorge', party: 'MC', title: 'Gobierno digital: datos abiertos por default', text: 'Toda información gubernamental debe ser pública por default. Solo se reserva lo estrictamente necesario por seguridad. El secreto generalizado es opacidad, no protección.', postType: 'policy', bskyTags: ['policy', 'datos', 'transparencia'], paraFlairs: ['||#Policy', '||#Innovacion']},
    {agent: 'jorge', party: 'MC', title: 'Smart cities: Jalisco como laboratorio', text: 'Semáforos inteligentes, basureros con sensores, alumbrado LED conectado. Guadalajara puede ser el laboratorio de ciudades inteligentes de Latinoamérica.', postType: 'matter', bskyTags: ['matter', 'smartcity', 'tecnologia'], paraFlairs: ['||#Innovacion', '|#Matter']},
    {agent: 'jorge', party: 'MC', title: 'Movilidad urbana: resultados de consulta', text: 'El 78% apoya ampliación de transporte público. La ciudadanía habla con datos. Nos toca escuchar y actuar, no solo sonreír en fotos.', postType: 'matter', bskyTags: ['matter', 'movilidad', 'urbana'], paraFlairs: ['|#Matter', '||#TransportePublico']},

    // Mariana (PRD — Abogada DDHH)
    {agent: 'mariana', party: 'PRD', title: 'Fiscalía autónoma: no negociable', text: 'Debe ser autónoma presupuestalmente y designarse por concurso público. No más dedazos, no más impunidad. La justicia no se negocia.', postType: 'policy', bskyTags: ['policy', 'fiscalia', 'anticorrupcion'], paraFlairs: ['||#Policy', '||#Anticorrupcion']},
    {agent: 'mariana', party: 'PRD', title: 'Paridad real: 50% de mujeres en todo', text: 'La paridad no es cuota, es justicia. 50% de mujeres en cargos de elección, dirección de dependencias y consejos ciudadanos. Nada menos es injusticia.', postType: 'policy', bskyTags: ['policy', 'paridad', 'mujeres'], paraFlairs: ['||#DerechosHumanos', '|#NiUnaMenos']},

    // Isabel (PRD — Activista feminista)
    {agent: 'isabel', party: 'PRD', title: 'Aborto legal, seguro y gratuito', text: 'La despenalización es justicia reproductiva. Ninguna persona debe morir por ejercer su derecho a decidir sobre su cuerpo. El Estado debe garantizar, no criminalizar.', postType: 'policy', bskyTags: ['policy', 'aborto', 'derechos'], paraFlairs: ['||#DerechosHumanos', '|#NiUnaMenos']},
    {agent: 'isabel', party: 'PRD', title: 'Justicia para defensores territoriales', text: '124 defensores ambientales asesinados en 4 años. Exigimos mecanismo de protección federal con presupuesto propio y protocolo de emergencia. No más lágrimas, más acción.', postType: 'matter', bskyTags: ['matter', 'ambiental', 'ddhh'], paraFlairs: ['||#DerechosHumanos', '|#Matter']},

    // Olivia (PRD — Artista urbana)
    {agent: 'olivia', party: 'PRD', title: 'Arte público como derecho ciudadano', text: 'El arte no es lujo, es derecho. Propongo que el 1% de inversión en infraestructura se destine a arte público. Las ciudades sin arte son almacenes de gente.', postType: 'policy', bskyTags: ['policy', 'arte', 'cultura'], paraFlairs: ['||#Cultura', '||#PresupuestoParticipativo']},
    {agent: 'olivia', party: 'PRD', title: 'Cuando el diputado dice "lo voy a estudiar"', text: 'Mi cara cuando llevo 3 años esperando que estudien la iniciativa de arte público... 🎨😭⏳', postType: 'meme', bskyTags: ['meme', 'politica', 'humor', 'arte'], paraFlairs: ['#MEME']},

    // Gabriela (Independiente — Periodista)
    {agent: 'gabriela', party: 'Independiente', title: 'Verificación: ¿bajarán las tarifas eléctricas?', text: 'Analicé 12 estudios independientes sobre la reforma energética. Los resultados son mixtos. Abro hilo con la evidencia que no te contaron.', postType: 'matter', bskyTags: ['periodismo', 'datos', 'energia', 'verificacion'], paraFlairs: ['||#PeriodismoDeDatos', '|#Matter']},
    {agent: 'gabriela', party: 'Independiente', title: 'Encuesta: ¿confías en los partidos?', text: '78% desconfía de partidos políticos. 64% confiaría más en asambleas ciudadanas digitales. Los datos hablan, los partidos no escuchan.', postType: 'open_question', bskyTags: ['encuesta', 'democracia', 'partidos', 'ciudadania'], paraFlairs: ['|#?OpenQuestion']},
    {agent: 'gabriela', party: 'Independiente', title: 'Nueva sección: Verificación Semanal', text: 'A partir de mañana, cada lunes desmonto 3 afirmaciones virales de políticos con datos duros. Suscríbete si prefieres evidencia sobre slogans.', postType: 'meta', bskyTags: ['periodismo', 'verificacion', 'anuncio', 'datos'], paraFlairs: ['||#PeriodismoDeDatos', '#META']},

    // Hector (Independiente — Académico)
    {agent: 'hector', party: 'Independiente', title: 'Impuesto al carbono: ¿regresivo o progresivo?', text: 'Modelo econométrico: con devolución a hogares, es progresivo en quintil 1-3, neutro en 4, ligeramente regresivo en 5. Los detalles importan más que los titulares.', postType: 'matter', bskyTags: ['economia', 'carbono', 'impuestos', 'analisis'], paraFlairs: ['||#Economia', '|#Matter']},
    {agent: 'hector', party: 'Independiente', title: 'Educación bilingüe: retorno de inversión', text: 'Estudio longitudinal: estudiantes bilingües tienen 23% más ingresos a los 30 años y mayor participación cívica. La inversión se recupera en 8 años. Datos, no opiniones.', postType: 'matter', bskyTags: ['educacion', 'bilingue', 'economia', 'estudio'], paraFlairs: ['||#EducacionIndigena', '|#Matter']},

    // Quetzali (Independiente — Comunidad zapoteca)
    {agent: 'quetzali', party: 'Independiente', title: 'Milpa tradicional vs agricultura industrial', text: 'En mi comunidad, la milpa de maíz criollo alimenta 12 familias por hectárea. La soja transnacional alimenta accionistas en Europa. ¿Cuál es el desarrollo que queremos?', postType: 'matter', bskyTags: ['milpa', 'soberania', 'indigena', 'agricultura'], paraFlairs: ['||#SoberaniaAlimentaria', '|#Matter']},

    // Pablo (meme)
    {agent: 'pablo', party: 'Morena', title: 'Yo explicándole a mi abuela qué es un cabildeo digital', text: 'Abuela: "¿Y eso para qué sirve?" Yo: "Para decidir cosas" Abuela: "¿Y antes no podíamos?" ...touché 👵💻', postType: 'meme', bskyTags: ['meme', 'humor', 'cabildeo', 'abuela'], paraFlairs: ['#MEME']},
  ]
  ...
  for (const p of seededPosts) {
    ...
    createdPosts.push({uri: paraRes.data.uri, cid: paraRes.data.cid, agent: user.agent, did: user.did, party: p.party, postType: p.postType, title: p.title})

    // Mirror to Bluesky
    const bskyText = `${p.title}\n\n${p.text}`
    await user.agent.app.bsky.feed.post.create(
      {repo: user.did},
      {text: bskyText, createdAt: createdAt(), tags: [...p.bskyTags, ...(p.paraFlairs || [])]},
    )
  }
  ...
  for (const post of likeablePosts) {
    ...
    for (const liker of likers) {
      if (liker.did !== post.did) {
        try {
          await sc.like(liker.did, {uri: post.uri, cid: post.cid})
        } catch (e) {/* ignore */}
      }
    }
  }
  ...
  const repostablePosts = createdPosts.filter((_, i) => i % 5 === 0 || i % 7 === 0)
  for (const post of repostablePosts) {
    const numReposts = 1 + Math.floor(Math.random() * 4)
    const reposters = [...users].sort(() => Math.random() - 0.5).slice(0, numReposts)
    for (const reposter of reposters) {
      if (reposter.did !== post.did) {
        try {
          await sc.repost(reposter.did, {uri: post.uri, cid: post.cid})
        } catch (e) {/* ignore */}
      }
    }
  }
  ...
  const replyDefs = [
    {postIdx: 0, user: 'bob', text: 'Interesante propuesta. ¿Han modelado el impacto en tarifas de usuarios industriales?'},
    {postIdx: 0, user: 'hector', text: 'Sí, el modelo muestra reducción de 12% para industriales que usen energía en horas valle.'},
    {postIdx: 0, user: 'jorge', text: '¿Y para data centers? Su consumo es 24/7 sin horas valle.'},
    {postIdx: 1, user: 'rodrigo', text: 'Como taxista, mi salario neto es $8,400. Esta propuesta me sacaría de la pobreza.'},
    {postIdx: 1, user: 'fernando', text: 'Las PYMEs necesitan subsidio transitorio. No todas pueden absorber el aumento inmediato.'},
    {postIdx: 2, user: 'dan', text: '¿Y en edificios históricos? La estructura puede no soportar el peso de jardines intensivos.'},
    {postIdx: 2, user: 'alice', text: 'Buen punto. El dictamen estructural es obligatorio. Solo edificios categoría A y B.'},
    {postIdx: 4, user: 'carla', text: 'Bienvenido Pablo. La participación juvenil es el futuro de la democracia.'},
    {postIdx: 4, user: 'pablo', text: 'Gracias Carla. Me sorprende cómo aquí se debate con respeto, a diferencia de otras redes.'},
    {postIdx: 8, user: 'mariana', text: 'La fiscalía autónoma debe tener acceso a información bancaria sin orden judicial previa. De lo contrario, es inútil.'},
    {postIdx: 8, user: 'gabriela', text: 'Discrepo. El acceso sin orden vulnera el debido proceso. La fiscalía debe ser ágil, no arbitraria.'},
    {postIdx: 8, user: 'mariana', text: 'Fair point. Propongo: orden judicial en 24h para cuentas nacionales, 72h para cuentas en paraísos fiscales.'},
    {postIdx: 14, user: 'eva', text: 'El tren cuesta $15,000M. Por esa mitad podríamos electrificar TODO el transporte público existente.'},
    {postIdx: 14, user: 'nicolas', text: 'Eva, la electrificación de flotas existentes es necesaria PERO insuficiente. La ciudad crece; necesitamos capacidad nueva.'},
    {postIdx: 14, user: 'rodrigo', text: 'Como taxista, prefiero que inviertan en los que YA existimos antes de construir infraestructura nueva.'},
    {postIdx: 22, user: 'gabriela', text: 'He verificado los datos del PRI. El promedio 8.5 es correcto según convocatoria oficial. La desinformación circuló en TikTok.'},
    {postIdx: 30, user: 'isabel', text: '124 defensores asesinados y el gobierno federal solo ha activado el protocolo de protección 8 veces. La omisión también es violencia.'},
    {postIdx: 30, user: 'mariana', text: 'Estoy litigando 3 casos de defensores. El mecanismo federal existe en papel, no en presupuesto.'},
    {postIdx: 34, user: 'hector', text: 'Tu modelo asume elasticidad precio de -0.3 para combustibles. Literatura reciente sugiere -0.15 para México. ¿Actualizaste?'},
    {postIdx: 34, user: 'dan', text: 'Tienes razón. Con -0.15 el recaudo cae 18%. Necesitamos ajustar la tarifa inicial o el umbral de devolución.'},
    {postIdx: 36, user: 'sofia', text: 'Milpa criolla vs soja: además de alimentar familias, la milpa conserva 847 especies asociadas. La soja monocultivo destruye suelo.'},
    {postIdx: 36, user: 'quetzali', text: 'Exacto. En mi comunidad, la milpa es bosque, mercado, medicina y ceremonia. No tiene precio en bolsa de commodities.'},
  ]
  ...
  for (const r of replyDefs) {
    ...
    if (post && user) {
      try {
        await sc.reply(user.did, {uri: post.uri, cid: post.cid}, r.text)
      } catch (e) {/* ignore */}
    }
  }
  ...
  for (const post of bookmarkablePosts) {
    ...
    const bookmarkers = [...users].sort(() => Math.random() - 0.5).slice(0, numBookmarks)
  ...
  const highlightDefs = [
    {user: 'alice', postIdx: 0, text: 'Dato clave: reducción de 4°C es significativa. Vale la pena citar en el dictamen.', start: 40, end: 90, color: '#22c55e', visibility: 'public'},
    {user: 'bob', postIdx: 8, text: 'Ojo: la consulta cierra en 48 hrs. Hay que difundir.', start: 0, end: 50, color: '#f59e0b', visibility: 'public'},
    {user: 'carla', postIdx: 2, text: 'Corrección importante para quienes ya enviaron solicitud.', start: 60, end: 110, color: '#3b82f6', visibility: 'private'},
    {user: 'hector', postIdx: 34, text: 'Elasticidad -0.15 es el dato actualizado. Revisar fuente.', start: 20, end: 80, color: '#ef4444', visibility: 'public'},
    {user: 'gabriela', postIdx: 22, text: 'Verificación confirmada. Periodismo de datos en acción.', start: 10, end: 60, color: '#22c55e', visibility: 'public'},
    {user: 'mariana', postIdx: 30, text: 'Protocolo existe en papel, no en presupuesto. Citar en litigio.', start: 50, end: 120, color: '#f59e0b', visibility: 'private'},
    {user: 'isabel', postIdx: 29, text: '124 defensores. El número debe estar en el titular.', start: 0, end: 40, color: '#ef4444', visibility: 'public'},
    {user: 'dan', postIdx: 16, text: 'Metas 2030 ambiciosas pero alcanzables con presupuesto adecuado.', start: 30, end: 90, color: '#3b82f6', visibility: 'public'},
    {user: 'eva', postIdx: 6, text: 'Premura vs calidad. El dilema de toda política pública.', start: 70, end: 130, color: '#a855f7', visibility: 'public'},
    {user: 'fernando', postIdx: 10, text: 'Transparencia total sin excepciones. Eso es lo que diferencia a MC.', start: 40, end: 100, color: '#22c55e', visibility: 'public'},
    {user: 'jorge', postIdx: 26, text: 'Datos abiertos por default. Estonia desde 2012. ¿Por qué nos tardamos tanto?', start: 20, end: 90, color: '#3b82f6', visibility: 'public'},
    {user: 'karla', postIdx: 32, text: '23% más ingresos a los 30 años. Esa es la evidencia que necesitamos.', start: 50, end: 110, color: '#22c55e', visibility: 'public'},
  ]
    ...
    try {
      await creator.agent.com.atproto.repo.createRecord({
        ...
        record: {
          ...
          description: 'Debate ciudadano en tiempo real sobre esta propuesta. Participa con tu posición y voto.',
          startedAt: createdAt(),
          status: 'active',
          maxParticipants: 500,
          createdAt: createdAt(),
  ...
  const liveParticipants = [
    {cabIdx: 6, users: ['alice', 'bob', 'carla', 'eva', 'rodrigo', 'fernando', 'hector', 'pablo']},
    {cabIdx: 8, users: ['isabel', 'bob', 'gabriela', 'mariana', 'alice', 'dan', 'carla', 'hector']},
    {cabIdx: 10, users: ['karla', 'quetzali', 'pablo', 'alice', 'eva', 'carla', 'isabel', 'hector']},
  ]
  ...
  const listDefs = [
    {creator: 'gabriela', name: 'Periodistas y Académicos', description: 'Voces independientes con rigor factual', members: ['gabriela', 'hector', 'mariana']},
    {creator: 'alice', name: 'Mujeres en Política', description: 'Liderazgo femenino en espacios de poder', members: ['alice', 'carla', 'eva', 'isabel', 'mariana', 'karla', 'olivia', 'quetzali', 'sofia']},
    {creator: 'fernando', name: 'Innovadores Cívicos', description: 'Quienes usan tecnología para transformar la política', members: ['fernando', 'jorge', 'nicolas', 'hector']},
    {creator: 'eva', name: 'Defensores Laborales', description: 'Voces sindicales y trabajadores organizados', members: ['eva', 'rodrigo', 'luis', 'tomas', 'karla']},
    {creator: 'dan', name: 'Ambientalistas', description: 'Activismo por el planeta y la justicia climática', members: ['dan', 'isabel', 'quetzali', 'sofia', 'luis']},
  ]
  ...
  for (let i = 0; i < createdPosts.length; i++) {
    ...
    if (!rkey) continue
    const partyBoard = partyBoards.find(pb => pb.name === p.party || (p.party === 'Independiente' && pb.name === 'Independientes'))
    try {
  ...
  console.log('')
  console.log('╔══════════════════════════════════════════════════════════════════════╗')
  console.log('║           🗳️  PARA ADVANCED DEMO SEED COMPLETE  🗳️                  ║')
  console.log('╠══════════════════════════════════════════════════════════════════════╣')
  console.log(`║  Users:              20  (5 politicians, 5 activists, 10 citizens)   ║`)
  console.log(`║  Party boards:       8   (Morena, PAN, PRI, PVEM, PT, MC, PRD, Ind)  ║`)
  console.log(`║  Civic communities:  12  (topic-based assemblies)                    ║`)
  console.log(`║  Cabildeos:          20  (2 draft, 4 open, 5 deliberating,           ║`)
  console.log(`║                        6 voting, 3 resolved)                         ║`)
  console.log(`║  Positions:          60+ (for/against/amendment/neutral)             ║`)
  console.log(`║  Votes:              ${totalVotes.toString().padEnd(3)} (weighted realistic turnout)                ║`)
  console.log(`║  Delegations:        25  (global + cabildeo-specific)                ║`)
  console.log(`║  Posts:              ${createdPosts.length.toString().padEnd(2)} (policy/matter/raq/meme/meta)      ║`)
  console.log(`║  Engagement:         likes, reposts, replies, bookmarks              ║`)
  console.log(`║  Highlights:         12  (public/private annotations)                ║`)
  console.log(`║  Live sessions:      3   (active deliberation rooms)                 ║`)
  console.log(`║  Lists:              5   (curated by community leaders)              ║`)
  console.log(`║  Verifications:      8   (politicians, journalists, academics)       ║`)
  console.log('╚══════════════════════════════════════════════════════════════════════╝')
  console.log('')
}
